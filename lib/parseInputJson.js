...
module.exports = function parseInputJson(ctx, inputJson)
{
  ...
  validateConfigProperty({
    ...
    defaultValue: 500,
    requiredValue: 'a number between 10 and 2000',
    validator: function(v) { return typeof v !== 'number' || v < 10 || v > 2000; }
  });
  validateConfigProperty({
  ...
  validateConfigProperty({
    propertyName: 'btConnectTryCount',
    defaultValue: 5,
    requiredValue: 'a number greater than or equal to 1',
    validator: function(v) { return typeof v !== 'number' || v < 1; }
  });
  validateConfigProperty({
    propertyName: 'btRequestDelay',
    defaultValue: 200,
    requiredValue: 'a number between 10 and 2000',
    validator: function(v) { return typeof v !== 'number' || v < 10 || v > 2000; }
  });
  validateConfigProperty({
    propertyName: 'btRequestRetryCount',
    defaultValue: 3,
    requiredValue: 'a number between 0 and 10',
    validator: function(v) { return typeof v !== 'number' || v < 0 || v > 10; }
  });
  validateConfigProperty({
