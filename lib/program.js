...
module.exports = function program(ctx, done)
{
  ...
  step(
    ...
    {
      ctx.progress.complete('program', 'setup');
    },
    ...
    function handleSetFactoryParametersStep(err)
    {
      ...
      ctx.progress.complete('program', 'set:factoryParameters');
    },
    ...
    function startVerificationStep(err)
    {
      ...
      ctx.progress.complete('program', 'set:schedule');
    },
    ...
    function verifyFactoryParametersStep(err, res)
    {
      ...
      ctx.progress.complete('program', 'verify:factoryParameters');
    },
    ...
    function(err)
    {
      ...
      ctx.progress.complete('program', 'verify:schedule');
    },
    done
  );
};
