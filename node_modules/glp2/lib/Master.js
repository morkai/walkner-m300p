 ...
 * @param {function(string, object): SerialPort} [options.createSerialPort]
...
function Master(options)
{
  ...
  if (typeof options.createSerialPort === 'function')
  {
 ...
 * @returns {SerialPort}
 */
Master.prototype.createSerialPort = function(comPort, options, openImmediately)
{
  return new (require('serialport').SerialPort)(comPort, options, openImmediately);
};
